...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h3 class="page-header"><i class="fa fa-desktop"></i> <?= $my_project_header_title; ?> <span style="color: blue;"><?= get_branch_name($user_branch_id) ?></span></h3>
                </div>
                <div class="col-lg-4">
                    <!-- notification here -->
                ...
                <div class="col-md-9">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            Order Table: <b><?= $count_items; ?> item(s)</b>
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
                                        <?php  
                                            ...
                                            while ($item_row=$get_items->fetch_array()) {
                                                ...
                                                @$total += $my_subtotal;
                                        ?>
                                            <tr class="<?= $my_quantity_status; ?>">
                                                <td style="padding: 1px;"><center><b><?= $item_row['gy_product_code']; ?></b></center></td>
                                                <td style="padding: 1px;"><center><b><a href="previewImage?productId=<?= $item_row['gy_product_id'] ?>" onclick="window.open(this.href, 'mywin', 'left=20, top=20, width=1280, height=720, toolbar=1, resizable=0'); return false;"><?= $item_row['gy_product_name']." ".$item_row['gy_product_desc']; ?></a></b></center></td>
                                                <td style="padding: 1px;"><center><b><?= number_format($item_row['gy_product_price_srp'],2); ?></b></center></td>
                                                <td style="padding: 1px;"><center><b><?= number_format($my_discount_val,2); ?></b></center></td>
                                                <td style="padding: 1px;"><center><b><?= number_format($item_row['gy_product_price'],2); ?></b></center></td>
                                                <td style="padding: 1px;"><center><b><?= $item_row['gy_trans_quantity']."</b> ".$item_row['gy_product_unit']; ?> (<span style="color: blue; font-weight: bold;"><?= $item_row['gy_product_quantity']; ?></span>)</center></td>
                                                <td style="padding: 1px;"><center><b><span style="color: blue;" id="pure_item"><?= number_format($my_subtotal,2); ?></span></b></center></td>
                                                <td style="padding: 1px;"><center><button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit_<?= $item_row['gy_transdet_id']; ?>" title="click to edit quantity ..."><i class="fa fa-edit fa-fw"></i></button></center></td>
                                                <td style="padding: 1px;"><center><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete_<?= $item_row['gy_transdet_id']; ?>" title="click to remove ..."><i class="fa fa-times fa-fw"></i></button></center></td>
                                            </tr>
                                            ...
                                            <div class="modal fade" id="edit_<?= $item_row['gy_transdet_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" enctype="multipart/form-data" action="edit_quantity_c?cd=<?= $item_row['gy_transdet_id']; ?>&dir=<?= $my_trans_code; ?>">

                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="">CAP: <span class="text-primary" title="<?= $item_row['gy_product_price_cap'] ?>"><?= toAlpha($item_row['gy_product_price_cap']) ?></span></label>

                                                                            <br>

                                                                            <label>Last Price -> <span style="color: blue;"><?= number_format($item_row['gy_product_discount_per'],2); ?></span></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label>Retail Price - (Php)</label>
                                                                            <input type="number" onkeyup="check_discount_for_pin<?= $item_row['gy_transdet_id']; ?>()" name="my_retail_price" id="my_retail_price<?= $item_row['gy_transdet_id']; ?>" step="0.01" value="<?= $item_row['gy_product_price']; ?>" class="form-control" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label>Quantity by <?= $item_row['gy_product_unit']; ?></label>
                                                                            <input type="number" name="my_quantity" min="0" step="0.01" value="<?= $item_row['gy_trans_quantity']; ?>" class="form-control" autofocus required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label style="color: blue;"><i class="fa fa-lock fa-fw"></i> ADMIN PIN</label>
                                                                            <input type="password" class="form-control" name="my_pin_edit" id="my_pin_edit<?= $item_row['gy_transdet_id']; ?>" required="false" disabled="true">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <button type="submit" name="submit_edit" id="submit_edit_<?= $item_row['gy_transdet_id']; ?>" class="btn btn-warning"><i class="fa fa-angle-right fa-fw"></i></button>
                                                                            &nbsp;&nbsp;&nbsp;<span style="color: red; font-weight: bold;" id="warnings_<?= $item_row['gy_transdet_id']; ?>"></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </form>
                                            ...
                                            <script type="text/javascript">
                                                function check_discount_for_pin<?= $item_row['gy_transdet_id']; ?>(){
                                                    var retail = <?= $item_row['gy_product_price_srp']; ?>;
                                                    var limit = <?= $item_row['gy_product_discount_per']; ?>;
                                                    var caps = <?= $item_row['gy_product_price_cap']; ?>;
                                                    var my_retail = document.getElementById('my_retail_price<?= $item_row['gy_transdet_id']; ?>').value;
                                                    ...
                                                    if (my_retail < limit) {
                                                        if (my_retail < rytcaps) {
                                                            //price too low
                                                            document.getElementById('warnings_<?= $item_row['gy_transdet_id']; ?>').innerHTML = "Your price is too low";
                                                            //disable button
                                                            $("#submit_edit_<?= $item_row['gy_transdet_id']; ?>").attr('disabled', true);

                                                            document.getElementById('my_pin_edit<?= $item_row['gy_transdet_id']; ?>').disabled = false;
                                                            document.getElementById('my_pin_edit<?= $item_row['gy_transdet_id']; ?>').required = true;
                                                        }else{
                                                            //remove warning
                                                            document.getElementById('warnings_<?= $item_row['gy_transdet_id']; ?>').innerHTML = "";
                                                            //enable button
                                                            $("#submit_edit_<?= $item_row['gy_transdet_id']; ?>").prop('disabled', false);
                                                        ...
                                                        document.getElementById('my_pin_edit<?= $item_row['gy_transdet_id']; ?>').disabled = true;
                                                        document.getElementById('my_pin_edit<?= $item_row['gy_transdet_id']; ?>').required = false;
                                                    }
                                            ...
                                            <div class="modal fade" id="delete_<?= $item_row['gy_transdet_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data" action="delete_item_c?cd=<?= $item_row['gy_transdet_id']; ?>&dir=<?= $my_trans_code; ?>">
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <p style="font-size: 18px;">Do You want to remove <span style="color: blue;"><?= $item_row['gy_product_name']; ?></span> on the list?</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <tr class="info">
                                            ...
                                            <td><center><b><span id="pure_total" style="font-size: 18px; color: blue;"><?= @number_format($total,2); ?></span></b></center></td>
                                            <td colspan="2"></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="my_cust_name" list="res_name" id="my_cust_name" value="<?= @$new_info_row['gy_trans_custname']; ?>" accesskey="2" autocomplete="off" class="form-control" placeholder="Customer Name (alt + 2)" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="my_cash" id="my_cash" min="<?= $total; ?>" onkeyup="get_the_change()" step="0.01" autocomplete="off" accesskey="3" class="form-control" placeholder="CASH (alt + 3)" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
