...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h3 class="page-header"><i class="fa fa-desktop"></i> <?= $my_project_header_title; ?></h3>
                </div>
                <div class="col-lg-4">
                    <!-- notification here -->
                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading" style="font-size: 20px;">
                            Transaction Code: <strong><?= $trans_row['gy_trans_code']; ?></strong>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th style="background-color: rgba(0,0,0,0.8); color: white; font-size: 20px;">Customer: &nbsp;&nbsp;<span style="text-transform: uppercase;"><?= $trans_row['gy_trans_custname']; ?></span></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><center><?= $item_row['gy_product_code']; ?></center></td>
                                            <td><center><?= $item_row['gy_product_name']." ".$item_row['gy_product_desc']; ?></center></td>
                                            <td><center><?= number_format(0 + $item_row['gy_product_price'], 2); ?></center></td>
                                            <td><center><?= number_format(0 + $my_discount_val, 2); ?></center></td>
                                            <td><center><?= $item_row['gy_trans_quantity']." ".$item_row['gy_product_unit']; ?></center></td>
                                            <td style="font-weight: bold;"><center><?= number_format(0 + $my_subtotal, 2); ?></center></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-weight: bold; font-size: 18px; background-color: rgba(0,0,0,0.8); color: white;"><center><?= number_format(0 + $total, 2); ?></center></td>
                                        </tr>

                                        <tr>
                                            <td colspan="4"></td>
                                            <td style="font-weight: bold; font-size: 18px; background-color: rgba(0,0,0,0.8); color: white;"><center>Cash</center></td>
                                            <td style="font-weight: bold; font-size: 18px; background-color: rgba(0,0,0,0.8); color: white;"><center><?= number_format(0 + $trans_row['gy_trans_cash'],2); ?></center></td>
                                        </tr>

                                        <tr>
                                            <td colspan="4"></td>
                                            <td style="font-weight: bold; font-size: 25px; background-color: rgba(0,0,0,0.8); color: rgb(0,255,64);"><center>Change</center></td>
                                            <td style="font-weight: bold; font-size: 25px; background-color: rgba(0,0,0,0.8); color: rgb(0,255,64);"><center><?= number_format(0 + $trans_row['gy_trans_change'], 2); ?></center></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" enctype="multipart/form-data" action="print_receipt_thermal_trans?cd=<?= $my_dir_value; ?>">
