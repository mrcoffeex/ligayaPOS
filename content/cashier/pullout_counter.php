<?php
    ...
    $my_project_header_title = "Pull-Out Counter <span style='color: blue;'>".$user_info."</span>";
    ...
    //my scripts
    $check_transaction=$link->query("Select * From `gy_pullout` Where `gy_pullout_by`='$user_id' AND `gy_pullout_status`='0'");
    $count_trans=$check_transaction->num_rows;

    if ($count_trans > 0) {
        $get_trans=$link->query("Select * From `gy_pullout` Where `gy_pullout_by`='$user_id' AND `gy_pullout_status`='0' Order By `gy_pullout_code` DESC");
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <form method="post" enctype="multipart/form-data" action="add_pullout_item?cd=<?php echo $my_trans_code; ?>">
                ...
                <?php  
                    ...
                    //items
                    $get_items=$link->query("Select * From `gy_pullout` Where `gy_pullout_code`='$my_trans_code' AND `gy_pullout_status`='0' AND `gy_pullout_by`='$user_id' Order By `gy_pullout_id` DESC");
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" enctype="multipart/form-data" action="edit_pullout_quantity?cd=<?php echo $item_row['gy_pullout_id']; ?>">
                                            ...
                                            <div class="modal fade" id="delete_<?php echo $item_row['gy_pullout_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data" action="delete_pullout_item?cd=<?php echo $item_row['gy_pullout_id']; ?>">
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                        ...
                        <div class="panel-body">
                            <form method="post" enctype="multipart/form-data" action="submit_pullout_transaction" onsubmit="return validateForm(this);">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="submit" name="submit_trans" id="submit_trans" class="btn btn-primary" style="width: 100%;"><i class="fa fa-chevron-circle-right fa-fw"></i> Submit Transaction (Enter)</button><br>
                                        </div>
                                    </div>
                                </div>
                            </form>
