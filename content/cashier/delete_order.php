<?php  
    ...
    if (isset($_POST['my_secure_pin'])) {
        ...
        if (encryptIt($my_secure_pin) == $get_values['gy_sec_value']) {
            ...
            $trans_void=$link->query("Insert Into `gy_void`(`gy_trans_code`, `gy_trans_pay`, `gy_trans_check_per`, `gy_trans_check_num`, `gy_trans_royal_fee`, `gy_trans_custname`, `gy_trans_date`, `gy_trans_type`, `gy_trans_total`, `gy_trans_discount`, `gy_trans_cash`, `gy_trans_change`, `gy_prepared_by`, `gy_user_id`, `gy_trans_status`, `gy_trans_check`, `gy_trans_check_date`, `gy_void_by`) Values('$my_trans_code','$my_trans_pay','$my_trans_check_per','$my_trans_check_num','$my_trans_royal_fee','$my_trans_custname','$my_trans_date','$my_trans_type','$my_trans_total','$my_trans_discount','$my_trans_cash','$my_trans_change','$my_prepared_by','$my_user_id','$my_trans_status','$my_trans_check','$my_trans_check_date','$approved_by')");

            if ($trans_void_details && $trans_void) {
                //delete query
                ...
                if ($delete_transaction && delete_trans_details) {
                    $my_note_text = "VOID ALERT ORDER - ".$my_dir_value." APPROVED BY -> ".$approved_by." AND WAS TRANSFERED TO VOID TRANSACTIONS";
                ...
                $delete_transac=$link->query("Delete From `gy_transaction` Where `gy_trans_code`='$my_dir_value'");
