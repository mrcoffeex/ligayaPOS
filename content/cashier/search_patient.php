<?php
    ...
    $query_one = "Select * From `gy_patient` Where CONCAT(`gy_pat_fname`,`gy_pat_lname`,`gy_pat_fullname`) LIKE '%$search_text%' Order By `gy_pat_fullname` ASC";

    $query_two = "Select COUNT(`gy_pat_id`) FROM `gy_patient` Where CONCAT(`gy_pat_fname`,`gy_pat_lname`,`gy_pat_fullname`) LIKE '%$search_text%' Order By `gy_pat_fullname` ASC";

    $query_three = "Select * from `gy_patient` Where CONCAT(`gy_pat_fname`,`gy_pat_lname`,`gy_pat_fullname`) LIKE '%$search_text%' Order By `gy_pat_fullname` ASC ";
