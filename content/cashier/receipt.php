                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    ?>
                                        ...
                                        <tr class="<?= $my_limit; ?>">
                                            <td style="font-weight: bold;"><center><?= $sales_row['gy_trans_code']; ?></center></td>
                                            <td style="font-weight: bold;"><center><?= $sales_row['gy_trans_custname']; ?></center></td>
                                            <td style="font-weight: bold;"><center><?= date("F d, Y g:i A",strtotime($sales_row['gy_trans_date'])); ?></center></td>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-danger" title="click to void transaction..." data-target="#delete_<?= $sales_row['gy_trans_code']; ?>" data-toggle="modal"><i class="fa fa-trash-o fa-fw"></i></button>
                                            </td>
                                        </tr>

                                        <!-- Delete -->

                                        <div class="modal fade" id="delete_<?= $sales_row['gy_trans_code']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
                                                        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash-o fa-fw"></i> Void Transaction Code - <?= $sales_row['gy_trans_code']; ?></h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form method="post" enctype="multipart/form-data" action="delete_sales?cd=<?= $sales_row['gy_trans_code']; ?>">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
