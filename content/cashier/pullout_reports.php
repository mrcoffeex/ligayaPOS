<?php
    ...
    $my_project_header_title = "Pull-Out Summary Report Today";
    ...
    $query_one = "Select * From `gy_pullout` Where date(`gy_pullout_date`)='$date_now' AND `gy_pullout_by`='$user_id' AND `gy_pullout_type`!='BACK_ORDER' Order By `gy_pullout_date` DESC";

    $query_two = "Select COUNT(`gy_pullout_id`) From `gy_pullout` Where date(`gy_pullout_date`)='$date_now' AND `gy_pullout_by`='$user_id' AND `gy_pullout_type`!='BACK_ORDER' Order By `gy_pullout_date` DESC";

    $query_three = "Select * From `gy_pullout` Where date(`gy_pullout_date`)='$date_now' AND `gy_pullout_by`='$user_id' AND `gy_pullout_type`!='BACK_ORDER' Order By `gy_pullout_date` DESC ";
