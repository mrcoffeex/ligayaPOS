<?php
    ...
    $my_project_header_title = "Cash Breakdown Today";
    ...
    }else if ($my_notification == "empty_date") {
        $the_note_status = "visible";
        $color_note = "warning";
...
<body onload="breakdown_calc();">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h3 class="page-header"><i class="fa fa-money"></i> <?php echo $my_project_header_title; ?> <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#custom_date" title="click to print input cash breakdown by date ..."><i class="fa fa-lock fa-fw"></i> Overwrite Cash Breakdown on day ...</button></h3>
                </div>
                <div class="col-lg-4">
                    <!-- notification here -->
            ...
            <div class="modal fade" id="custom_date" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Date</label>
                                            <input type="date" name="my_custom_date" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label style="color: blue;"><i class="fa fa-lock fa-fw"></i> ADMIN PIN</label>
                                            <input type="password" class="form-control" name="my_secure_pin" placeholder="number here ..." required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <button type="submit" name="overwrite" class="btn btn-danger" title="click to proceed ..."><i class="fa fa-lock fa-fw"></i> Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="post" enctype="multipart/form-data" action="update_breakdown_over">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon" style="border-radius: 0px;">Total Amount</span>
                                            <input type="number" name="over_all" id="over_all" class="form-control" min="0" step="0.01" value="<?php echo 0+$over_all_data; ?>" style="border-radius: 0px;" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon" style="border-radius: 0px;">READING</span>
                                            <input type="number" name="over_all_reading" id="over_all_reading" class="form-control" min="0" step="0.01" value="0" style="color: blue; border-radius: 0px;" readonly required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group input-group">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="number" class="form-control" min="0" step="0.01" name="partial" id="partial" value="<?php echo 0 + $my_total_partial; ?>" readonly required>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">1000 X </span>
                                    <input type="number" class="form-control" min="0" name="a_a" id="a_a" value="<?php echo 0+$break_row['gy_break_a_a']; ?>" autofocus onkeyup="breakdown_calc()" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon" color: blue; font-weight: bold;"><i class="fa fa-lock fa-fw"></i> PIN</span>
                                            <input type="password" class="form-control" name="my_secure_pin" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="submit" name="submit_breakdown_all" class="btn btn-lg btn-info" style="width: 100%;"><i class="fa fa-check fa-fw"></i> Submit Cash Breakdown</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span style="color: green;">Beginning Balance Breakdown Assistant</span> 
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <!-- Over-All Cash Breakdown -->
                            <!-- <form method="post" enctype="multipart/form-data" action="update_breakdown_remain"> -->
                                
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon" style="border-radius: 0px;">Beg. Balance</span>
                                            <input type="number" name="remaining" id="remaining" class="form-control" min="0" step="0.01" value="<?php echo 0+$get_beginning_cash_row['gy_beg_cash']; ?>" style="border-radius: 0px;" readonly required>
                                        </div>
                                    </div><div class="col-md-6">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon" style="border-radius: 0px;">READING</span>
                                            <input type="number" name="remaining_reading" id="remaining_reading" class="form-control" min="0" step="0.01" value="0" style="color: green; border-radius: 0px;" readonly required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">1000 X </span>
                                    <input type="number" class="form-control" min="0" name="a_a_a" id="a_a_a" value="0" onkeyup="breakdown_calc()" required>
                                    <span class="input-group-addon"> = <span id="a_b_a" style="color: green;">0.00</span></span>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">500 X </span>
                                    <input type="number" class="form-control" min="0" name="a_a_b" id="a_a_b" value="0" onkeyup="breakdown_calc()" required>
                                    <span class="input-group-addon"> = <span id="a_b_b" style="color: green;">0.00</span></span>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">200 X </span>
                                    <input type="number" class="form-control" min="0" name="a_a_c" id="a_a_c" value="0" onkeyup="breakdown_calc()" required>
                                    <span class="input-group-addon"> = <span id="a_b_c" style="color: green;">0.00</span></span>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">100 X </span>
                                    <input type="number" class="form-control" min="0" name="a_a_d" id="a_a_d" value="0" onkeyup="breakdown_calc()" required>
                                    <span class="input-group-addon"> = <span id="a_b_d" style="color: green;">0.00</span></span>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">50 X </span>
                                    <input type="number" class="form-control" min="0" name="a_a_e" id="a_a_e" value="0" onkeyup="breakdown_calc()" required>
                                    <span class="input-group-addon"> = <span id="a_b_e" style="color: green;">0.00</span></span>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">20 X </span>
                                    <input type="number" class="form-control" min="0" name="a_a_f" id="a_a_f" value="0" onkeyup="breakdown_calc()" required>
                                    <span class="input-group-addon"> = <span id="a_b_f" style="color: green;">0.00</span></span>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">10 X </span>
                                    <input type="number" class="form-control" min="0" name="a_a_g" id="a_a_g" value="0" onkeyup="breakdown_calc()" required>
                                    <span class="input-group-addon"> = <span id="a_b_g" style="color: green;">0.00</span></span>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">5 X </span>
                                    <input type="number" class="form-control" min="0" name="a_a_h" id="a_a_h" value="0" onkeyup="breakdown_calc()" required>
                                    <span class="input-group-addon"> = <span id="a_b_h" style="color: green;">0.00</span></span>
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="width: 30%;">1 X </span>
                                    <input type="number" class="form-control" min="0" step="0.01" name="a_a_i" id="a_a_i" value="0" onkeyup="breakdown_calc()" required>
                                    <span class="input-group-addon"> = <span id="a_b_i" style="color: green;">0.00</span></span>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group input-group">
                                            <span class="input-group-addon" color: blue; font-weight: bold;">STATUS</span>
                                            <input type="text" class="form-control" name="my_remaining_status" id="my_remaining_status" readonly required>
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="col-md-6">
                                    <div class="form-group input-group">
                                        <span class="input-group-addon" color: blue; font-weight: bold;">ADMIN PIN</span>
                                        <input type="password" class="form-control" name="my_secure_pin" required>
                                    </div>
                                </div> -->
                                <!-- <div class="form-group">
                                    <button type="submit" name="submit_breakdown_remain" class="btn btn-lg btn-success" style="width: 100%;"><i class="fa fa-check fa-fw"></i> Submit Cash Breakdown</button>
                                </div> -->
                            <!-- </form> -->
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function breakdown_calc(){
            ...
            var a_a_a = document.getElementById('a_a_a').value;
            var a_a_b = document.getElementById('a_a_b').value;
            var a_a_c = document.getElementById('a_a_c').value;
            var a_a_d = document.getElementById('a_a_d').value;
            var a_a_e = document.getElementById('a_a_e').value;
            var a_a_f = document.getElementById('a_a_f').value;
            var a_a_g = document.getElementById('a_a_g').value;
            var a_a_h = document.getElementById('a_a_h').value;
            var a_a_i = document.getElementById('a_a_i').value;
            ...
            var reading_remaining = ff(a_a_a * 1000)  + ff(a_a_b * 500) + ff(a_a_c * 200) + ff(a_a_d * 100) + ff(a_a_e * 50) + ff(a_a_f * 20) + ff(a_a_g * 10) + ff(a_a_h * 5) + ff(a_a_i);

            if (<?php echo $beg_cash; ?> == reading_remaining) {
                document.getElementById('my_remaining_status').value = "PERFECT";
                document.getElementById('my_remaining_status').style.color = "blue";
            }else if (<?php echo $beg_cash; ?> > reading_remaining) {
                document.getElementById('my_remaining_status').value = "SHORT";
                document.getElementById('my_remaining_status').style.color = "red";
            }else{
                document.getElementById('my_remaining_status').value = "OVER";
                document.getElementById('my_remaining_status').style.color = "green";
            }
            ...
            if (!isNaN(reading_remaining)) {
                document.getElementById('a_b_a').innerHTML = ff(a_a_a * 1000);
                document.getElementById('a_b_b').innerHTML = ff(a_a_b * 500);
                document.getElementById('a_b_c').innerHTML = ff(a_a_c * 200);
                document.getElementById('a_b_d').innerHTML = ff(a_a_d * 100);
                document.getElementById('a_b_e').innerHTML = ff(a_a_e * 50);
                document.getElementById('a_b_f').innerHTML = ff(a_a_f * 20);
                document.getElementById('a_b_g').innerHTML = ff(a_a_g * 10);
                document.getElementById('a_b_h').innerHTML = ff(a_a_h * 5);
                document.getElementById('a_b_i').innerHTML = ff(a_a_i);

                document.getElementById('remaining_reading').value = reading_remaining;
            }else{
                document.getElementById('a_b_a').innerHTML = 0;
                document.getElementById('a_b_b').innerHTML = 0;
                document.getElementById('a_b_c').innerHTML = 0;
                document.getElementById('a_b_d').innerHTML = 0;
                document.getElementById('a_b_e').innerHTML = 0;
                document.getElementById('a_b_f').innerHTML = 0;
                document.getElementById('a_b_g').innerHTML = 0;
                document.getElementById('a_b_h').innerHTML = 0;
                document.getElementById('a_b_i').innerHTML = 0;

                document.getElementById('remaining_reading').value = 0;
            }
        }
    </script>
