        ...
        if ($count_items == 0) {
            ...
            if ($my_type == "FOR_USE") {
                ...
                while ($use_row=$get_trans_use->fetch_array()) {
                    ...
                    //the product codes
                    $product_codes=words($use_row['gy_product_code']);

                    //get the total amount
                    $get_product_info=$link->query("Select * From `gy_products` Where `gy_product_code`='$product_codes'");
                    ...
                    //add to expenses
                    $insert_exp=$link->query("Insert Into `gy_expenses`(`gy_exp_note`,`gy_exp_type`,`gy_exp_amount`,`gy_user_id`,`gy_approved_by`,`gy_exp_date`) Values('$my_exp_note','$my_type','$my_total_amount','$user_id','$user_id','$date_now')");
            ...
            if ($update_data) {
                ...
                header("location: print_psummary?cd=$my_code&mode=trans");
