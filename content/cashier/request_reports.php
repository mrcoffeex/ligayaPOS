<?php
    ...
    $my_project_header_title = "Quotation Report Today";
    ...
    $getQuotations=$link->query("SELECT DISTINCT gy_rqt_code From gy_rqt Where gy_rqt_status='1' AND date(gy_rqt_date) = '$date_now' Order By gy_rqt_date DESC");
