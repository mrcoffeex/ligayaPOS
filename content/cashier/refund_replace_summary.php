<?php
    ...
    $my_project_header_title = "Refund/Replace Summary Today";
    ...
    $query_one = "Select * From `gy_refund` Where date(`gy_refund_date`)='$date_now' AND `gy_user_id`='$user_id' Order By `gy_refund_id` ASC";

    $query_two = "Select COUNT(`gy_refund_id`) From `gy_refund` Where date(`gy_refund_date`)='$date_now' AND `gy_user_id`='$user_id' Order By `gy_refund_id` ASC";

    $query_three = "Select * From `gy_refund` Where date(`gy_refund_date`)='$date_now' AND `gy_user_id`='$user_id' Order By `gy_refund_id` ASC ";
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Refund Summary Data Table - <span style="color: green;">REFUND</span> / <span style="color: #9c9c00;">REPLACE</span> - <b><?php echo 0+$count_results; ?></b> result(s)
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    ?>
                                        ...
                                        <tr class="<?php echo $my_row_color; ?>">
                                            ...
                                            <td style="font-weight: bold;"><center><?php echo $ref_row['gy_product_name']." ".$p_row['gy_product_desc']; ?></center></td>
