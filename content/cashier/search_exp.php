<?php
    ...
    $my_project_header_title = "Search Expenses - ".date("F d, Y", strtotime($search_text));
    ...
    $my_query=$link->query("Select * From `gy_expenses` Where date(`gy_exp_date`)='$search_text' Order By `gy_exp_date` DESC");
