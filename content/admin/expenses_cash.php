<?php
    ...
    $my_project_header_title = "Cost of Sales Today";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h3 class="page-header"><a href="exp_general"><button type="button" class="btn btn-success" title="click to go back to general expenses ..."><i class="fa fa-arrow-left fa-fw"></i></button></a> <i class="fa fa-credit-card"></i> <?php echo $my_project_header_title; ?></h3>
                </div>
                <div class="col-lg-4">
                    <!-- notification here -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <span style="float: right;"> Press <span style="color: blue;">F5</span> to refresh results</span> <a href="print_exp?datef=<?php echo date('Y-m-d'); ?>&datet=<?php echo date('Y-m-d'); ?>&condition=cash" onclick="window.open(this.href, 'mywin',
