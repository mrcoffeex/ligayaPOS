        ...
        if ($count_res > 0) {
            ...
            if ($my_discount <= $my_discount_limit) {
                ...
                if ($update_data) {
                    ...
                    header("location: edit_quotation?note=add_discount&cd=".$info_row['gy_trans_code']."");
                }else{
                    header("location: edit_quotation?note=error&cd=".$info_row['gy_trans_code']."");
                }
            }else{
                header("location: edit_quotation?note=discount_limit&cd=".$info_row['gy_trans_code']."");
            }

            
        }else{
            header("location: edit_quotation?note=pin_error&cd=".$info_row['gy_trans_code']."");
        }
