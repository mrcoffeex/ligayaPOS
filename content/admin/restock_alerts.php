<?php
    ...
    $my_project_header_title = "Re-Stock Alerts";
    ...
    $query_one = "Select * From `gy_products` Where `gy_product_quantity`<=`gy_product_restock_limit` Order By `gy_product_name` ASC";

    $query_two = "Select COUNT(`gy_product_id`) FROM `gy_products` Where `gy_product_quantity`<=`gy_product_restock_limit` Order By `gy_product_name` ASC";

    $query_three = "Select * From `gy_products` Where `gy_product_quantity`<=`gy_product_restock_limit` Order By `gy_product_name` ASC ";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h3 class="page-header"><i class="fa fa-info-circle fa-fw"></i> <?php echo $my_project_header_title; ?> <a href="print_restock_alerts" onclick="window.open(this.href, 'mywin',
