<?php
    ...
    $my_project_header_title = "<span style='color: red;'>Back-Order Summary Reports</span>";

    $my_notification = @$_GET['note'];

    $date_now = date("Y-m-d");

    if ($my_notification == "checked") {
        $the_note_status = "visible";
        $color_note = "success";
        $message = "Order has been checked";
    }else if ($my_notification == "checked") {
        $the_note_status = "visible";
        $color_note = "success";
        $message = "Order has been unchecked";
    ...
    $query_one = "Select * From `gy_pullout` Where `gy_pullout_type`='BACK_ORDER' Order By `gy_pullout_date` DESC";

    $query_two = "Select COUNT(`gy_pullout_id`) From `gy_pullout` Where `gy_pullout_type`='BACK_ORDER' Order By `gy_pullout_date` DESC";

    $query_three = "Select * From `gy_pullout` Where `gy_pullout_type`='BACK_ORDER' Order By `gy_pullout_date` DESC ";
