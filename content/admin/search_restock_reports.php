<?php
    ...
    $my_query=$link->query("Select * From `gy_restock` Where `gy_restock_status`='1' AND date(`gy_restock_date`) BETWEEN '$datef' AND '$datet' Order By `gy_restock_date` ASC");
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Stock Receive Summary Data Table <b><?php echo 0+$count_results; ?></b> result(s) <a href="print_rsummary?datef=<?php echo $datef; ?>&datet=<?php echo $datet; ?>&mode=date_search" onclick="window.open(this.href, 'mywin',
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php  
                                        //get products
                                        //make pagination
                                        while ($res_row=$my_query->fetch_array()) {
