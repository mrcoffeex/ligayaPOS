                ...
                <form method="post" enctype="multipart/form-data" action="edit_this_product?cd=<?php echo $my_product_id; ?>&pn=<?= $pagenum; ?>&s_type=<?= $s_type; ?>&br=<?= $br; ?>&search_text=<?php echo $search_text; ?>" onsubmit="return validateForm(this);">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" maxlength="100" name="my_code" value="<?php echo $product_row['gy_product_code']; ?>" required>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="2" maxlength="100" name="my_desc" placeholder="text here ..."><?php echo htmlentities($product_row['gy_product_desc']); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
