<?php  
    ...
    $my_product_price_cap = $product_row['gy_product_price_cap'];
    ...
    if (isset($_POST['my_code'])) {
        ...
        if ($my_product_code == $my_code){
            //insert to database
            $update_data=$link->query("UPDATE `gy_products` SET `gy_product_code`='$my_code',`gy_product_cat`='$my_category',`gy_supplier_code`='$my_supplier',`gy_product_name`='$my_name',`gy_product_desc`='$my_desc',`gy_product_unit`='$my_unit',`gy_product_price_cap`='$my_price_cap',`gy_product_price_srp`='$my_price_srp',`gy_product_quantity`='$my_quantity',`gy_product_discount_per`='$my_limit',`gy_product_restock_limit`='$my_restock_limit',`gy_product_update_date`='$date_now' Where `gy_product_id`='$my_dir_value'");
            ...
            if ($update_data) {
                ...
                $note_text = $my_product_name." Product Update -> ".$my_a."".$my_b."".$my_c."".$my_d."".$my_e."".$my_f."".$my_g."".$my_h."".$my_i."".$my_j."".$my_k;
