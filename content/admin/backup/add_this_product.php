<?php  
    ...
    if (isset($_POST['my_code'])) {
        ...
        if ($count_duplicate > 0){
            ...
            //insert to database
            $insert_data=$link->query("INSERT Into `gy_products`(`gy_product_code`, `gy_product_cat`, `gy_supplier_code`, `gy_product_name`, `gy_product_desc`, `gy_product_unit`, `gy_product_price_cap`, `gy_product_price_srp`, `gy_product_quantity`, `gy_product_discount_per`, `gy_product_restock_limit`, `gy_product_date_restock`, `gy_product_date_reg`, `gy_added_by`,`gy_update_code`,`gy_product_update_date`,`gy_branch_id`) Values('$my_code','$my_category','$my_supplier','$my_name','$my_desc','$my_unit','$my_price_cap','$my_price_srp','$my_quantity','$my_limit','$my_restock_limit','$date_now','$date_now','$user_id','$randoms','$date_now','$my_branch')");
