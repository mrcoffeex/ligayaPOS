<?php
    ...
    if ($search_text == "mrcoffeex_only_space") {
        ...
        $my_project_header_title = "Search Product Image: ".$search_text;
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6">  
                            <!-- Search Engine -->
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Search for Product Bar Code/Product Name/Category/Supplier Name/Update Code ..." name="image_search" value="<?= $search_text ?>" style="border-radius: 0px;" autofocus>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <!-- Buttons -->
                            ...
                            <div class="modal fade" id="upload_<?php echo $product_row['gy_product_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="updateProductImage?productId=<?= $product_row['gy_product_id'] ?>&pn=<?= $pagenum ?>&s_type=search&search_text=<?= $search_text ?>" onsubmit="btnLoader(this.uploadImage)">
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
