<?php
    ...
    $my_project_header_title = "Pull-Out Report Today";
    ...
    if ($my_notification == "delete") {
        ...
        $color_note = "success";
        $message = "Pull-Out Report is removed";
    ...
    $query_one = "Select * From `gy_pullout` Where date(`gy_pullout_date`)='$date_now' AND `gy_pullout_type`!='BACK_ORDER' AND `gy_pullout_status`='1' Order By `gy_pullout_date` DESC";

    $query_two = "Select COUNT(`gy_pullout_id`) From `gy_pullout` Where date(`gy_pullout_date`)='$date_now' AND `gy_pullout_type`!='BACK_ORDER' AND `gy_pullout_status`='1' Order By `gy_pullout_date` DESC";

    $query_three = "Select * From `gy_pullout` Where date(`gy_pullout_date`)='$date_now' AND `gy_pullout_type`!='BACK_ORDER' AND `gy_pullout_status`='1' Order By `gy_pullout_date` DESC ";
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Pull-Out Data Table <span style="color: green;">FOR USE</span> / <span style="color: red;">DAMAGE ITEM</span> / <span style="color: #009fb1;">SOLD</span> <b><?php echo 0+$count_results; ?></b> result(s) <a href="print_psummary?datef=<?php echo date('Y-m-d'); ?>&datet=<?php echo date('Y-m-d'); ?>&mode=date_search" onclick="window.open(this.href, 'mywin',
                                        ...
                                        <div class="modal fade" id="void_<?php echo $pull_row['gy_pullout_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
                                                        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash-o fa-fw"></i> Void Pull-Out Data <small style="color: #337ab7;">(press TAB to type/press ENTER to process)</small></h4>
                                                    </div>
                                                    <div class="modal-body">
