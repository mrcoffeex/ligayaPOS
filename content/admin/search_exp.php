<?php
    ...
    if ($datef == $datet) {
        $my_project_header_title = "Search Overheads: ".date("M d, Y", strtotime($datef));
    }else{
        $my_project_header_title = "Search Overheads: ".date("M d", strtotime($datef))." - ".date("M d, Y", strtotime($datet));
    }
                ...
                <div class="col-md-12">
                                    ...
                                    <form method="post" enctype="multipart/form-data" action="add_exp">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input type="date" name="my_date" class="form-control" autofocus required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <span style="float: right;"> Press <span style="color: blue;">F5</span> to refresh results</span> <a href="print_exp?datef=<?php echo $datef; ?>&datet=<?php echo $datet; ?>&condition=notcash" onclick="window.open(this.href, 'mywin',
                                                        ...
                                                        <form method="post" enctype="multipart/form-data" action="edit_exp?cd=<?php echo $exp_row['gy_exp_id']; ?>&sd=expenses">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label>Amount</label>
                                                                        <input type="number" name="my_amount" min="0" class="form-control" value="<?php echo $exp_row['gy_exp_amount']; ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
