<?php
    ...
    if ($search_text == "mrcoffeex_only_space") {
        ...
        $my_project_header_title = "Re-Stock Alerts Product Search: ".$search_text;

        $query_one = "Select * From `gy_products` Where CONCAT(`gy_product_code`,`gy_product_name`) Like '%$search_text%' AND `gy_product_quantity`<=`gy_product_restock_limit` Order By `gy_product_name` ASC";

        $query_two = "Select COUNT(`gy_product_id`) FROM `gy_products` Where CONCAT(`gy_product_code`,`gy_product_name`) Like '%$search_text%' AND `gy_product_quantity`<=`gy_product_restock_limit` Order By `gy_product_name` ASC";

        $query_three = "Select * From `gy_products` Where CONCAT(`gy_product_code`,`gy_product_name`) Like '%$search_text%' AND `gy_product_quantity`<=`gy_product_restock_limit` Order By `gy_product_name` ASC ";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-search fa-fw"></i> <?php echo $my_project_header_title; ?> <a href="print_restock_alerts?mode=common_search&cd=<?php echo $search_text; ?>" onclick="window.open(this.href, 'mywin',
