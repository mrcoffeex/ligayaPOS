<?php
    ...
    $my_query=$link->query("Select * From `gy_pullout` Where `gy_pullout_type`!='BACK_ORDER' AND `gy_pullout_status`='1' AND date(`gy_pullout_date`) BETWEEN '$datef' AND '$datet'  Order By `gy_pullout_date` DESC");
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Pull-Out Data Table <span style="color: green;">FOR USE</span> / <span style="color: red;">DAMAGE ITEM</span> / <span style="color: #009fb1;">SOLD</span> <b><?php echo 0+$count_results; ?></b> result(s) <a href="print_psummary?datef=<?php echo $datef; ?>&datet=<?php echo $datet; ?>&mode=date_search" onclick="window.open(this.href, 'mywin',
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php  
                                        //get products
                                        //make pagination
                                        while ($pull_row=$my_query->fetch_array()) {
                                            //get product details
