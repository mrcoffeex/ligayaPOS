<?php
    ...
    $my_project_header_title = "Quotations";
    ...
    $query_one = "Select * From `gy_transaction` Where `gy_trans_type`='0' AND `gy_trans_status`='1' Order By `gy_trans_code` ASC";

    $query_two = "Select COUNT(`gy_trans_id`) From `gy_transaction` Where `gy_trans_type`='0' AND `gy_trans_status`='1' Order By `gy_trans_code` ASC";

    $query_three = "Select * From `gy_transaction` Where `gy_trans_type`='0' AND `gy_trans_status`='1' Order By `gy_trans_code` ASC ";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- <div class="row">
                        <div class="col-md-6">
                            <a href="sales_counter"><button type="button" class="btn btn-primary"><i class="fa fa-desktop fa-fw"></i> Back to Counter</button></a>
                        </div>
                        <hr>
                    </div> -->
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    ?>
                                        ...
                                        <tr class="<?php echo $my_limit; ?>">
                                            ...
                                            <!-- <td><center><a href="edit_quotation?cd=<?php# echo $quotation_row['gy_trans_code']; ?>"><button type="button" class="btn btn-info" title="click to print quotaion form"><i class="fa fa-cogs fa-fw"></i></button></a></center></td> -->
                                            <td><center><a href="print_quotation?cd=<?php echo $quotation_row['gy_trans_code']; ?>"><button type="button" class="btn btn-success" title="click to print quotaion form"><i class="fa fa-print fa-fw"></i></button></a></center></td>
                                        ...
                                        <div class="modal fade" id="delete_<?php echo $quotation_row['gy_trans_code']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" enctype="multipart/form-data" action="delete_form?cd=<?php echo $quotation_row['gy_trans_code']; ?>">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" name="delete_form" class="btn btn-danger">Remove</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
