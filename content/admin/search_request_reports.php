<?php
    ...
    $crqt=$link->query("Select DISTINCT `gy_rqt_code` From `gy_rqt` Where `gy_rqt_status`='1' AND date(`gy_rqt_date`) BETWEEN '$datef' AND '$datet' Order By `gy_rqt_date` DESC");
                                        ...
                                        <div class="modal fade" id="void_<?php echo $res_row['gy_rqt_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
                                                        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-trash-o fa-fw"></i> Void Request Order Data <small style="color: #337ab7;">(press TAB to type/press ENTER to process)</small></h4>
                                                    </div>
                                                    <div class="modal-body">
