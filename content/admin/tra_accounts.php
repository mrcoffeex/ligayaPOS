<?php
    ...
    $my_project_header_title = "TRA Accounts";
    ...
    if ($my_notification == "delete") {
        ...
        $color_note = "success";
        $message = "Great Job!";
    }else if ($my_notification == "print_receipt") {
        $the_note_status = "visible";
        $color_note = "success";
        $message = "Take the receipt in the Cashier";
    ...
    $query_one = "Select * From `gy_accounts` Order By `gy_acc_name` ASC";

    $query_two = "Select COUNT(`gy_acc_id`) From `gy_accounts` Order By `gy_acc_name` ASC";

    $query_three = "Select * From `gy_accounts` Order By `gy_acc_name` ASC ";
