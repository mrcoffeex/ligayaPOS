<?php
    ...
    if ($search_text == "mrcoffeex_only_space") {
        ...
        $my_project_header_title = "<span style='color: red;'>Back-Order Summary Reports</span> Search: <span style='color: blue;'>".$search_text."</span>";

        $query_one = "Select * From `gy_pullout` Where `gy_pullout_type`='BACK_ORDER' AND `gy_pullout_code` LIKE '%$search_text%' Order By `gy_pullout_date` DESC";

        $query_two = "Select COUNT(`gy_pullout_id`) From `gy_pullout` Where `gy_pullout_type`='BACK_ORDER' AND `gy_pullout_code` LIKE '%$search_text%' Order By `gy_pullout_date` DESC";

        $query_three = "Select * From `gy_pullout` Where `gy_pullout_type`='BACK_ORDER' AND `gy_pullout_code` LIKE '%$search_text%' Order By `gy_pullout_date` DESC ";
