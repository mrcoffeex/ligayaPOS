    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="panel panel-warning">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo @number_format(0+$total_sales,2) ?></div>
                                        </div>
                                    </div>
                                </div>
                                <a href="sales_report" title="click to go to sales ...">
                                    <div class="panel-footer">
                                        <span class="pull-left">Sales Today</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                        <div class="clearfix"></div>
                                    </div>
                                </a>
                            ...
                            <div class="panel panel-danger">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?php echo number_format(0+$count_voids); ?></div>
                                            <div></div>
                                        </div>
                                    </div>
                                </div>
                                <a href="void_trans" title="click to go to void transactions ...">
                                    <div class="panel-footer">
                                        <span class="pull-left">Void Transactions Today</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                        <div class="clearfix"></div>
                                    </div>
                                </a>
                        ...
                        <div class="col-md-3">
                            <div class="panel panel-info">
                                ...
                                <a href="users" title="click to go to users ...">
                                    <div class="panel-footer">
                ...
                <div class="modal fade" id="sales_search" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" tabindex="-1" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            ...
                            <div class="modal-body">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" name="sales_search" class="form-control" placeholder="Search for Trasaction Code/Customer Name ..." autofocus required>
                                            </div>
                                        </div>
                                        </form>
                                    </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bell fa-fw"></i> <a href="notification">Notifications Panel</a>
                        </div>
