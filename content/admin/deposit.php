<?php
    ...
    $my_project_header_title = "Deposit Items Result Today";

    $my_notification = @$_GET['note'];

    if ($my_notification == "nice_check") {
