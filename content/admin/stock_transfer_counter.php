<?php
    ...
    }else if ($my_notification == "stocks_transfer") {
        $the_note_status = "visible";
        $color_note = "success";
        $message = "Stocks Transferred";
    ...
    //my scripts
    $check_transaction=$link->query("Select * From `gy_stock_transfer` Where `gy_transfer_by`='$user_id' AND `gy_transfer_status`='0' AND `gy_branch_from`='$branch_id'");
    $count_trans=$check_transaction->num_rows;

    if ($count_trans > 0) {
        $get_trans=$link->query("Select * From `gy_stock_transfer` Where `gy_transfer_by`='$user_id' AND `gy_transfer_status`='0' AND `gy_branch_from`='$branch_id' Order By `gy_transfer_code` DESC");
        $get_trans_row=$get_trans->fetch_array();

        $my_trans_code = $get_trans_row['gy_transfer_code'];
    }else{
        $get_latest_trans=$link->query("Select * From `gy_stock_transfer` Order By `gy_transfer_code` DESC LIMIT 1");
        $trans_row=$get_latest_trans->fetch_array();

        if ($trans_row['gy_transfer_code'] == 0) {
            $my_trans_code = "1001";
        }else{
            $my_trans_code = $trans_row['gy_transfer_code'] + 1;
        }
    }

    $my_project_header_title = "Stock Transfer <span style='color: #f0ad4e;'>".$branch_name."</span>";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <form method="post" enctype="multipart/form-data" action="add_transfer_item?br_id=<?= $branch_id; ?>&cd=<?php echo $my_trans_code; ?>">
                ...
                <?php  
                    ...
                    //items
                    $get_items=$link->query("Select * From `gy_stock_transfer` Where `gy_transfer_code`='$my_trans_code' AND `gy_transfer_status`='0' AND `gy_transfer_by`='$user_id' AND `gy_branch_from`='$branch_id' Order By `gy_transfer_id` DESC");
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="warning">
                                                ...
                                                <td><center><b><?php echo $item_row['gy_transfer_quantity']."</b> ".$product_row['gy_product_unit']; ?></center></td>
                                                <td><center><button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit_<?php echo $item_row['gy_transfer_id']; ?>" title="click to edit quantity ..."><i class="fa fa-edit fa-fw"></i></button></center></td>
                                                <td><center><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete_<?php echo $item_row['gy_transfer_id']; ?>" title="click to remove ..."><i class="fa fa-times fa-fw"></i></button></center></td>
                                            </tr>
                                            ...
                                            <div class="modal fade" id="edit_<?php echo $item_row['gy_transfer_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" enctype="multipart/form-data" action="edit_transfer_quantity?br_id=<?= $branch_id; ?>&cd=<?php echo $item_row['gy_transfer_id']; ?>">

                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label>Quantity by <?php echo $product_row['gy_product_unit']; ?></label>
                                                                            <input type="number" name="my_quantity" step="0.01" min="0" value="<?php echo $item_row['gy_transfer_quantity']; ?>" class="form-control" autofocus required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                            ...
                                            <div class="modal fade" id="delete_<?php echo $item_row['gy_transfer_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data" action="delete_transfer_item?br_id=<?= $branch_id; ?>&cd=<?php echo $item_row['gy_transfer_id']; ?>">
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                ...
                <div class="col-md-3">
                    <div class="panel panel-yellow">
                        ...
                        <div class="panel-body">
                            <form method="post" enctype="multipart/form-data" action="submit_transfer_transaction" onsubmit="return validateForm(this);">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Stock-Transfer Code</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="my_branch_from" readonly required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="my_branch" required>
                                                ...
                                                <?php  
                                                    //get branches
                                                    $get_branch=$link->query("Select * From `gy_branch` Where `gy_branch_id`!='$branch_id'");
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Note</label>
                                            <textarea name="my_note" class="form-control" rows="2" placeholder="Ex. PO#, request by, ETC" required></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Transfer By:</label>
                                            <input type="text" name="my_transfer_by" class="form-control" value="<?php echo $user_info; ?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="submit" name="submit_trans" id="submit_trans" class="btn btn-warning" style="width: 100%;"><i class="fa fa-chevron-circle-right fa-fw"></i> Submit Transaction</button><br>
                                        </div>
                                    </div>
                                </div>
                            </form>
