    ...
    if ($search_text == "mrcoffeex_only_space") {
         echo "
            <script>
                ...
                window.location.href = 'restock_reports'
            </script>
         ";
        ...
        $my_project_header_title = "Stock Receive Reports Search: <span style='color: blue;'>".$search_text."</span>";

        $query_one = "Select * From `gy_restock` Where `gy_restock_status`='1' AND CONCAT(`gy_supplier_code`,`gy_restock_code`) Like '%$search_text%' Order By `gy_restock_date` ASC";

        $query_two = "Select COUNT(`gy_restock_id`) From `gy_restock` Where `gy_restock_status`='1' AND CONCAT(`gy_supplier_code`,`gy_restock_code`) Like '%$search_text%' Order By `gy_restock_date` ASC";

        $query_three = "Select * From `gy_restock` Where `gy_restock_status`='1' AND CONCAT(`gy_supplier_code`,`gy_restock_code`) Like '%$search_text%' Order By `gy_restock_date` ASC ";
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Stock Receive Summary Data Table <b><?php echo 0+$count_results; ?></b> result(s) <a href="print_rsummary?cd=<?php echo $search_text; ?>&mode=entry_search" onclick="window.open(this.href, 'mywin',
