<?php
    ...
    if ($my_dir_value != "") {
        ...
        //no trans code bakc to sales counter
        header("location: sales_counter");
    }
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        <form method="post" enctype="multipart/form-data" action="add_item_q?cd=<?php echo $my_trans_code; ?>">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <a href="quotations"><button type="button" class="btn btn-success" title="click to open Quotations ..." accesskey="q"><i class="fa fa-file-o fa-fw"></i> Quotation Forms (alt + q)</button></a>
                    </div>
                </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" enctype="multipart/form-data" action="edit_quantity_q?cd=<?php echo $item_row['gy_transdet_id']; ?>&sd=<?php echo $item_row['gy_trans_code']; ?>">
                                            ...
                                            <div class="modal fade" id="discount_<?php echo $item_row['gy_transdet_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" enctype="multipart/form-data" action="add_discount_q?cd=<?php echo $item_row['gy_transdet_id']; ?>">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                            ...
                                            <div class="modal fade" id="delete_<?php echo $item_row['gy_transdet_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data" action="delete_item_q?cd=<?php echo $item_row['gy_transdet_id']; ?>&sd=<?php echo $item_row['gy_trans_code']; ?>">
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
