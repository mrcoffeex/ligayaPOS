<?php
    ...
    $transinfo=$link->query("Select * From `gy_tra` Where `gy_trans_code`='$my_dir_value'");
    $transinforow=$transinfo->fetch_array();
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <p style="font-size: 12px;">
                                ...
                                <span style="font-weight: bold; font-size: 15px;"><?php echo $transinforow['gy_trans_custname']; ?></span><br>
                            </p>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" style="width: 100%; margin-bottom: 20px;">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        $total=0;
                                        $sql_item_detail=$link->query("Select * From `gy_tra_details` LEFT JOIN `gy_products` On `gy_tra_details`.`gy_product_code`=`gy_products`.`gy_product_code` Where `gy_tra_details`.`gy_trans_code`='$my_dir_value' Order By `gy_products`.`gy_product_price_srp` DESC");
                                ...
                                <?php } ?>                   
                                    <tr>
                                        ...
                                        <td class="pla" style="padding: 4px; font-size: 15px; text-align: right; font-weight: bold;"><?php echo @number_format($transinforow['gy_trans_total'],2); ?></td>
                                    </tr>                  
                                    <tr>
                                        <td class="pla" style="padding: 4px; font-size: 15px; text-align: right;">&nbsp;</td>
                                        <td class="pla" style="padding: 4px; font-size: 15px;"><center>&nbsp;</center></td>
                                        <td class="pla" style="padding: 4px; font-size: 15px;text-align: right; font-weight: bold;"><center>Interest</center></td>
                                        <td class="pla" style="padding: 4px; font-size: 15px; text-align: right; font-weight: bold;"><?php echo @number_format($transinforow['gy_trans_interest'],2); ?></td>
                                    </tr>                  
                                    <tr>
                                        <td class="pla" style="padding: 4px; font-size: 15px; text-align: right;">&nbsp;</td>
                                        <td class="pla" style="padding: 4px; font-size: 15px;"><center>&nbsp;</center></td>
                                        <td class="pla" style="padding: 4px; font-size: 15px;text-align: right; font-weight: bold;"><center>Total</center></td>
                                        <td class="pla" style="padding: 4px; font-size: 15px; text-align: right; font-weight: bold;"><?php echo @number_format($transinforow['gy_trans_total'] + $transinforow['gy_trans_interest'],2); ?></td>
                                    </tr>                  
                                    <tr>
                                        <td class="pla" style="padding: 4px; font-size: 15px; text-align: right;">&nbsp;</td>
                                        <td class="pla" style="padding: 4px; font-size: 15px;"><center>&nbsp;</center></td>
                                        <td class="pla" style="padding: 4px; font-size: 15px;text-align: right; font-weight: bold;"><center>Paid Amount</center></td>
                                        <td class="pla" style="padding: 4px; font-size: 15px; text-align: right; font-weight: bold;"><?php echo @number_format($transinforow['gy_trans_cash'],2); ?></td>
                                    </tr>                  
                                    <tr>
                                        <td class="pla" style="padding: 4px; font-size: 15px; text-align: right;">&nbsp;</td>
                                        <td class="pla" style="padding: 4px; font-size: 15px;"><center>&nbsp;</center></td>
                                        <td class="pla" style="padding: 4px; font-size: 15px;text-align: right; font-weight: bold;"><center>Balance</center></td>
                                        <td class="pla" style="padding: 4px; font-size: 15px; text-align: right; font-weight: bold;"><?php echo @number_format(($transinforow['gy_trans_total'] + $transinforow['gy_trans_interest'] - $transinforow['gy_trans_cash']),2); ?></td>
                                    </tr>
