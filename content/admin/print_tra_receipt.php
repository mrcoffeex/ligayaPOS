    ...
    <body onload="window.print()">
        ...
        <?php } ?>   
            <tr>
                ...
                <td class="pla" style="font-size: 20px;"><strong>TOTAL</strong></td>
                <td class="pla" style="font-size: 20px;">Php <strong><?php echo number_format("$total",2);  ?></strong></td>
            </tr>                                   
        </tbody>
    </table>    
        ...
        <div>
            ...
            <p style="font-size: 15px; text-transform: uppercase;">
                <b>NOTICE</b>: NOTICE: This is just a Withdrawal Slip Not valid for claiming input tax this serves as your   proff of payment.
            </p></center>
        </div>
